            ...
            <div className='flex items-center gap-2 opacity-70'>
              {role === 'user' ? (
                <>
                  ...
                  <Image src={assets.pencil_icon} alt='Edit' className='w-5 cursor-pointer' />
                </>
              ) : (
                <>
                  <Image onClick={copyMessage} src={assets.copy_icon} alt='Copy' className='w-5 cursor-pointer' />
